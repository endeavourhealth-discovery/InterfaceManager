 ...
 */
@JsonAdapter(COMPONENT.Adapter.class)
public enum COMPONENT {
  ...
  public static class Adapter extends TypeAdapter<COMPONENT> {
    @Override
    public void write(final JsonWriter jsonWriter, final COMPONENT enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public COMPONENT read(final JsonReader jsonReader) throws IOException {
