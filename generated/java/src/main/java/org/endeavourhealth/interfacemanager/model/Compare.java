...
public class Compare {
  ...
  public Compare left(@javax.annotation.Nullable ValueSource left) {
    this.left = left;
    return this;
  }
  ...
  public void setLeft(@javax.annotation.Nullable ValueSource left) {
    this.left = left;
  }


  public Compare right(@javax.annotation.Nullable ValueSource right) {
    this.right = right;
    return this;
  }
  ...
  public void setRight(@javax.annotation.Nullable ValueSource right) {
    this.right = right;
  }


  public Compare units(@javax.annotation.Nullable TTIriRef units) {
    this.units = units;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.left, compare.left) &&
        Objects.equals(this.right, compare.right) &&
        Objects.equals(this.units, compare.units);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Compare.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Compare` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `left`
      if (jsonObj.get("left") != null && !jsonObj.get("left").isJsonNull()) {
        ValueSource.validateJsonElement(jsonObj.get("left"));
      }
      // validate the optional field `right`
      if (jsonObj.get("right") != null && !jsonObj.get("right").isJsonNull()) {
        ValueSource.validateJsonElement(jsonObj.get("right"));
      }
