...
/**
 * Gets or Sets ImVocab
 */
@JsonAdapter(ImVocab.Adapter.class)
public enum ImVocab {
  ...
  public static ImVocab fromValue(String value) {
    for (ImVocab b : ImVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<ImVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final ImVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ImVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ImVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ImVocab.fromValue(value);
  }
}
