...
/**
 * Gets or Sets NamespaceVocab
 */
@JsonAdapter(NamespaceVocab.Adapter.class)
public enum NamespaceVocab {
  ...
  public static NamespaceVocab fromValue(String value) {
    for (NamespaceVocab b : NamespaceVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<NamespaceVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final NamespaceVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NamespaceVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NamespaceVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NamespaceVocab.fromValue(value);
  }
}
