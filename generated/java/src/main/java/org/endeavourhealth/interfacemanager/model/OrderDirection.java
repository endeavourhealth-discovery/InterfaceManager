...
public class OrderDirection {
  ...
  public OrderDirection function(@javax.annotation.Nullable FunctionClause function) {
  ...
  public OrderDirection nodeRef(@javax.annotation.Nullable String nodeRef) {
  ...
  public OrderDirection variable(@javax.annotation.Nullable String variable) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderDirection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDirection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderDirection is not found in the empty JSON string", OrderDirection.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderDirection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderDirection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderDirection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderDirection.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderDirection>() {
           @Override
           public void write(JsonWriter out, OrderDirection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderDirection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderDirection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderDirection
   * @throws IOException if the JSON string is invalid with respect to OrderDirection
   */
  public static OrderDirection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderDirection.class);
  }

  /**
   * Convert an instance of OrderDirection to an JSON string
   *
   * @return JSON string
   */
