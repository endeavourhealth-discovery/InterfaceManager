...
/**
 * Gets or Sets OwlVocab
 */
@JsonAdapter(OwlVocab.Adapter.class)
public enum OwlVocab {
  ...
  public static OwlVocab fromValue(String value) {
    for (OwlVocab b : OwlVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<OwlVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final OwlVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OwlVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OwlVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OwlVocab.fromValue(value);
  }
}
