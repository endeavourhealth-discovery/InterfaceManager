...
public class Prefix {
  ...
  public Prefix prefix(@javax.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public Prefix namespace(@javax.annotation.Nullable String namespace) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.prefix, prefix.prefix) &&
        Objects.equals(this.namespace, prefix.namespace);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Prefix.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Prefix is not found in the empty JSON string", Prefix.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Prefix.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Prefix` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
