...
/**
 * Gets or Sets QueryVocab
 */
@JsonAdapter(QueryVocab.Adapter.class)
public enum QueryVocab {
  ...
  public static QueryVocab fromValue(String value) {
    for (QueryVocab b : QueryVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<QueryVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final QueryVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public QueryVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return QueryVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    QueryVocab.fromValue(value);
  }
}
