...
/**
 * Gets or Sets ShaclVocab
 */
@JsonAdapter(ShaclVocab.Adapter.class)
public enum ShaclVocab {
  ...
  public static ShaclVocab fromValue(String value) {
    for (ShaclVocab b : ShaclVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<ShaclVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final ShaclVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ShaclVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ShaclVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ShaclVocab.fromValue(value);
  }
}
