...
public class Throwable {
  ...
  public Throwable cause(@javax.annotation.Nullable Throwable cause) {
    this.cause = cause;
    return this;
  }
  ...
  public Throwable stackTrace(@javax.annotation.Nullable List<StackTraceElement> stackTrace) {
  ...
  public Throwable message(@javax.annotation.Nullable String message) {
  ...
  public Throwable suppressed(@javax.annotation.Nullable List<Throwable> suppressed) {
  ...
  public Throwable localizedMessage(@javax.annotation.Nullable String localizedMessage) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Throwable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Throwable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Throwable is not found in the empty JSON string", Throwable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Throwable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Throwable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Throwable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Throwable.class));

       return (TypeAdapter<T>) new TypeAdapter<Throwable>() {
           @Override
  ...
  /**
   * Create an instance of Throwable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Throwable
   * @throws IOException if the JSON string is invalid with respect to Throwable
   */
  public static Throwable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Throwable.class);
  }

  /**
   * Convert an instance of Throwable to an JSON string
   *
   * @return JSON string
   */
