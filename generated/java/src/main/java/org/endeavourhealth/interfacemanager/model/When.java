...
public class When {
  ...
  public When then(@javax.annotation.Nullable String then) {
    this.then = then;
    return this;
  }
  ...
  public When exists(@javax.annotation.Nullable Boolean exists) {
    this.exists = exists;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to When
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!When.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in When is not found in the empty JSON string", When.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!When.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'When' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<When> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(When.class));

       return (TypeAdapter<T>) new TypeAdapter<When>() {
           @Override
  ...
  /**
   * Create an instance of When given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of When
   * @throws IOException if the JSON string is invalid with respect to When
   */
  public static When fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, When.class);
  }

  /**
   * Convert an instance of When to an JSON string
   *
   * @return JSON string
   */
