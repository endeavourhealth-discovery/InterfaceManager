...
public class WorkflowResponse {
  ...
  public WorkflowResponse page(@javax.annotation.Nullable Integer page) {
    this.page = page;
    return this;
  }
  ...
  public WorkflowResponse count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public WorkflowResponse tasks(@javax.annotation.Nullable List<Task> tasks) {
    this.tasks = tasks;
    return this;
  }

  public WorkflowResponse addTasksItem(Task tasksItem) {
    if (this.tasks == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.page, workflowResponse.page) &&
        Objects.equals(this.count, workflowResponse.count) &&
        Objects.equals(this.tasks, workflowResponse.tasks);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WorkflowResponse is not found in the empty JSON string", WorkflowResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
