...
/**
 * Gets or Sets WorkflowVocab
 */
@JsonAdapter(WorkflowVocab.Adapter.class)
public enum WorkflowVocab {
  ...
  public static WorkflowVocab fromValue(String value) {
    for (WorkflowVocab b : WorkflowVocab.values()) {
  ...
  public static class Adapter extends TypeAdapter<WorkflowVocab> {
    @Override
    public void write(final JsonWriter jsonWriter, final WorkflowVocab enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WorkflowVocab read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WorkflowVocab.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WorkflowVocab.fromValue(value);
  }
}
