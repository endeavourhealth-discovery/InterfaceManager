...
export function instanceOfIM(value: any): boolean {
    for (const key in IM) {
        if (Object.prototype.hasOwnProperty.call(IM, key)) {
            if (IM[key as keyof typeof IM] === value) {
                return true;
            }
        }
    }
...
export function IMFromJSON(json: any): IM {
    return IMFromJSONTyped(json, false);
}

export function IMFromJSONTyped(json: any, ignoreDiscriminator: boolean): IM {
    return json as IM;
}

export function IMToJSON(value?: IM | null): any {
    return value as any;
}

export function IMToJSONTyped(value: any, ignoreDiscriminator: boolean): IM {
    return value as IM;
}
