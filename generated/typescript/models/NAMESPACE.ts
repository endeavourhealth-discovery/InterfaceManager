...
export function instanceOfNAMESPACE(value: any): boolean {
    for (const key in NAMESPACE) {
        if (Object.prototype.hasOwnProperty.call(NAMESPACE, key)) {
            if (NAMESPACE[key as keyof typeof NAMESPACE] === value) {
                return true;
            }
        }
    }
...
export function NAMESPACEToJSONTyped(value: any, ignoreDiscriminator: boolean): NAMESPACE {
