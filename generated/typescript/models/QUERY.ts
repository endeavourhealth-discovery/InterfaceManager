...
export function instanceOfQUERY(value: any): boolean {
    for (const key in QUERY) {
        if (Object.prototype.hasOwnProperty.call(QUERY, key)) {
            if (QUERY[key as keyof typeof QUERY] === value) {
                return true;
            }
        }
    }
...
export function QUERYToJSONTyped(value: any, ignoreDiscriminator: boolean): QUERY {
